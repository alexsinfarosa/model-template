      ...
      <div className="w-full">
                      ...
                      return (
                        ...
                        >
                          ...
                          <td
                            className={`${
                              i === 2 ? `text-lg` : `text-xs`
                            } px-6 py-4 border-b border-gray-200 leading-6 ${riskLevel}`}
                          >
                            {day.gdd}
                          </td>
                          <td
                    ...
                    data.forecast.map(day => {
                      ...
                      return (
                        <tr key={day.date} className="text-center">
                          ...
                          <td
                            className={`px-6 py-4 border-b border-gray-200 text-sm leading-6 ${riskLevel}`}
                          >
                            {day.gdd}
                          </td>
                          <td className="px-6 py-4 border-b border-gray-200 text-sm leading-6 text-gray-700">
        ...
        {data && (
          <div className="flex justify-between items-center mx-auto my-3 max-w-2xl">
            ...
            <span className="py-1 bg-green-500 flex-1 mx-2 text-sm text-center text-green-900 font-semibold rounded">
              Low
            </span>
            <span className="py-1 bg-orange-400 flex-1 mx-2 text-sm text-center text-orange-900 font-semibold rounded">
              Moderate
            </span>
            <span className="py-1 bg-red-500 flex-1 mx-2 text-sm text-center text-red-900 font-semibold rounded">
              High
            </span>
          </div>
        )}
